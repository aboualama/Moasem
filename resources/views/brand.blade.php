...
<!-- banner -->
    <div class="banner4" style="background-image:url({{asset('uploads/brand')}}/{{$brand->img }}); " id="home1">
        <div class="container">
            <h2>{{ $brand->name }}</h2>
        </div>
    </div>
...
{{-- products products --}}
            ...
            @else
                ...
                <h1 style="text-transform: capitalize; text-align: center;">There is no product in brand
                    { <span style="color: #FF9B05"> {{$brand->name}}</span> }
                </h1>      
